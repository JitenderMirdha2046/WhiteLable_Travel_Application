...
import { FiCompass, FiStar, FiShield, FiZap, FiArrowRight, FiMapPin, FiCalendar } from 'react-icons/fi'
...
const features = [
  ...
  { icon: RupeeIcon, title: 'Budget Optimization', desc: 'Get the best value with intelligent budget allocation across your trip.' },
    ...
    <div className="min-h-screen overflow-hidden relative bg-surface">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pb-4">
        <motion.div className="text-center mb-10" {...fadeUp}>
          <h2 className="text-4xl font-bold text-white mb-4">
            Visit <span className="gradient-text">{agencyName}</span>
          </h2>
          <p className="text-gray-400">Find us on the map — we'd love to help you plan your next trip in person.</p>
        </motion.div>
        <AgencyMap
          agency={{
            name: agencyName,
